...
import "./navbar.css";
import logo from "../../../assets/images/logo.png";
import { RiArrowDropDownLine, RiPlantFill, RiNodeTree } from "react-icons/ri";
import { FiSettings } from "react-icons/fi";
import { BsGraphUpArrow, BsFillPersonFill, BsWindowDock } from "react-icons/bs";
import { AiOutlineBarChart, AiFillBug, AiFillMessage } from "react-icons/ai";
        ...
        <div className="links">
          <ul>
            ...
            >
              ...
              {dropdownIndex === 0 && (
                <div className="dropdown-content">
                  <a href="/dex" onClick={handleClearButtonClick}>
                    <BsWindowDock /> &nbsp;&nbsp; Simple swap{" "}
                  </a>
                  {/* <Link to={"/"} href="#"><BsWindowDock/> &nbsp;&nbsp; Simple swap</Link>
                  <br></br> */}
                  {/* <Link to={"/classicswap"} href="#"><BsGraphUpArrow/> &nbsp; &nbsp; Classic Swap</Link> */}
                  <a href="/dex/classicswap" onClick={handleButtonClick}>
                    {" "}
                    <BsGraphUpArrow /> &nbsp; Classic Swap
                  </a>

                  <a to="/dex/limitorder" href="#">
                    <AiOutlineBarChart />
                    &nbsp;&nbsp;Limit Order{" "}
                  </a>
                </div>
